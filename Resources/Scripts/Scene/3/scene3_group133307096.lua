...
-- 装置
gadgets = {
	{ config_id = 96001, gadget_id = 70211101, pos = { x = -2493.453, y = 190.949, z = 4520.597 }, rot = { x = 0.000, y = 180.000, z = 9.708 }, level = 26, drop_tag = "解谜低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 26 },
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_GADGET_DIE_96003", "GADGET_STATE_CHANGE_96004", "ANY_GADGET_DIE_96005" },
		rand_weight = 100
	}
}
