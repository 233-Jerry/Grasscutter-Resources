...
- BinOutput (3.3 GIO: Talent,Scene>SceneNpcBorn,LevelEntity,Gadget,Avatar,AbilityGroup | GC 3.3 Scene>Point,Quest,HomeworldDefaultSave | GC ?.? LevelDesign>Routes)
- Scripts (3.3 GIO)
- Readable (??)
- Subtitle (??)
- TextMap (??)
